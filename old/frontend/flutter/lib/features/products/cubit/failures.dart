...
///
/// @param failureSelector A function to extract the [ProductsFailure] from the cubit state [S].
...
BlocListener<C, S> listenForProductsFailures<C extends Cubit<S>, S>({
  required ProductsFailure Function(S state) failureSelector,
