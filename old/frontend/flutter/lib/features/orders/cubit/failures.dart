...
///
/// @param failureSelector A function to extract the [OrdersFailure] from the cubit state [S].
...
BlocListener<C, S> listenForOrdersFailures<C extends Cubit<S>, S>({
  required OrdersFailure Function(S state) failureSelector,
