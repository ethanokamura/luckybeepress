...
///
/// @param failureSelector A function to extract the [OrderItemsFailure] from the cubit state [S].
...
BlocListener<C, S> listenForOrderItemsFailures<C extends Cubit<S>, S>({
  required OrderItemsFailure Function(S state) failureSelector,
