...
class CreateAddressesPage extends AppStatefulWidget {
  const CreateAddressesPage({super.key});

  @override
  State<CreateAddressesPage> createState() => _CreateAddressesPageState();
}

class _CreateAddressesPageState extends State<CreateAddressesPage> {
        ...
        child: Column(
          children: [
            AppCard(
              child: AppColumn(
                children: [
                  AppHeading.h3('Addresses Values'),
                  ...List.generate(
                    nonNull.length,
                    (index) => AppTextField(
                      semanticLabel:
                  ...
                  AppSpacer(),
                  AppButton(
                      semanticLabel: 'create-addresses',
                      text: 'Create',
                      onPressed: () async {
                        try {
                          ...
                          AppSnackbar.showError(
                            context: context,
                            message: 'Failed to create a addresses',
                          );
                        }
                      }),
                ],
