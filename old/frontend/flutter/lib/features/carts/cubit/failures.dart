...
///
/// @param failureSelector A function to extract the [CartsFailure] from the cubit state [S].
...
BlocListener<C, S> listenForCartsFailures<C extends Cubit<S>, S>({
  required CartsFailure Function(S state) failureSelector,
