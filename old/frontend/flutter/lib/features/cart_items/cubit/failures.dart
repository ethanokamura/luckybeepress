...
///
/// @param failureSelector A function to extract the [CartItemsFailure] from the cubit state [S].
...
BlocListener<C, S> listenForCartItemsFailures<C extends Cubit<S>, S>({
  required CartItemsFailure Function(S state) failureSelector,
